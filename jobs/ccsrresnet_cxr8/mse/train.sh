...
python train_ccsrresnet.py --data /data/pacole2/miniCXR8/images --dataset CXR8 --upscale 1 --content_loss mse --checkpointdir checkpoints/ccsrresnet_cxr8/mse/ --checksample --wlmbda 1e-3 --load
