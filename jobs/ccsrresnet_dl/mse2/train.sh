...
python -u train_ccsrresnet.py --data /data/pacole2/DeepLesionPreprocessed/miniStudies/ --tdata /data/pacole2/DeepLesionTestPreprocessed/miniStudies/ --dataset DeepLesion --upscale 1 --content_loss mse --checkpointdir checkpoints/ccsrresnet_dl/mse2/ --checksample --wlmbda 1e-3 --batch 32 --epochs 300 --start_decay 250 --load