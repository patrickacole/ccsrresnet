...
python train_psrresnet.py --data /data/pacole2/miniCXR8/images --dataset CXR8 --upscale 1 --epochs 500 --sr_index 2 --content_loss wdist --checkpointdir checkpoints/psrresnet_cxr8/wdist/ --checksample
