...
python process_deep_lesion.py /data/pacole2/DeepLesion/ --image_size 128 128

# Data is ready now run python file
cd ~/Projects/freq-sr/
echo "Running python script now..."
python train_srresnet.py --data /data/pacole2/DeepLesion/miniStudies/ --dataset DeepLesion --upscale 1 --content_loss mse --checkpointdir checkpoints/srresnet_dl/mse/ --checksample --wlmbda 1e-3
