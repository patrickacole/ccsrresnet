...
class DilatedResidualBlock(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=2, dilation=2, bias=True)
        self.in1 = nn.BatchNorm2d(64, affine=True)
        self.relu = nn.LeakyReLU(0.2, inplace=True)
        self.conv2 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=2, dilation=2, bias=True)
        self.in2 = nn.BatchNorm2d(64, affine=True)
...
class DSRResNet(nn.Module):
    ...
    def make_layer(self, block1, block2, num_of_layer):
        layers = []
...
if __name__=="__main__":
    model = DSRResNet(nc=1, upscale=2)
