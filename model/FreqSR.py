...
class FreqSR(nn.Module):
    def __init__(self, shape=(3, 128, 128), scale_factor=2):
        ...
        self.block1 = FreqSRBlock(out_shape, 18)
        self.block2 = FreqSRBlock(out_shape, 18)
        self.block3 = FreqSRBlock(out_shape, 18)
        self.block4 = FreqSRBlock(out_shape, 18)
        self.conv1x1 = nn.Conv2d(3 * 4, 3, kernel_size=1)
