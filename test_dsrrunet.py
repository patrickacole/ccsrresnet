...
from model.DSRRUNet import DSRRUNet
...
def args_parse():
    ...
    parser.add_argument('--savedir', default="output/dsrrunet/", help="Path to store generated super resolution files")
    parser.add_argument('--checkpointdir', default="checkpoints/dsrrunet/", help="Path to checkpoint directory")
...
if __name__=="__main__":
    print("Beginning testing for DSRRUNet model...")
    args = args_parse()
    ...
    modelSR = DSRRUNet(nc=1, upscale=2)
