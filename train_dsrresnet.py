...
def args_parse():
    ...
    parser.add_argument('--checkpointdir', default="checkpoints/dsrresnet/", help="Path to checkpoint directory")
...
if __name__=="__main__":
    print("Beginning training for DSRResNet model...")
    args = args_parse()
    ...
    modelSR = DSRResNet(nc=1, upscale=args.upscale)
