...
def args_parse():
    ...
    parser.add_argument('--sr_index', default=2, type=int, help="Train generator every <sr_index> epoch")
    ...
    parser.add_argument('--content_loss', default="wdist", help="Content loss can currently be mse, abs, wdist, or None")
...
if __name__=="__main__":
    ...
    print("SR Index:             " + str(args.sr_index))
